...
Falcon = Image.open("/Users/derekcentineo/Analytics/Risk_Ranges_Beta/Falcon.jpeg")
...
def get_input():
    ...
    trend_period = st.sidebar.slider("Trend Period", min_value=60, max_value=750,value=63, step=1)
